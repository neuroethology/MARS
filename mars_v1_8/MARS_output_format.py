...
def get_feat_no_ext(video_fullpath, output_folder, view, output_suffix=''):
    ...
    feat_basename = output_plus_mouse + '_' + feat_designator
    return feat_basename
...
def get_classifier_savename(video_fullpath, output_folder, view='top', classifier_path='', output_suffix='', model_type='xgb'):
    if not output_suffix:
        output_suffix = get_version_suffix()
